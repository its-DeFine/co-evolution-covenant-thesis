# References (peer‑reviewed + standards)

This bibliography is intentionally strict: sources are either peer‑reviewed (journals / refereed conference proceedings) or formal standards/specifications (e.g. W3C, EIPs). Unrefereed preprints are excluded from this list.

## Learning science (retention, transfer, practice)
...
## Performance measurement, incentives, and gaming (Goodharting dynamics)
...
- W3C (2022). *Verifiable Credentials Data Model v1.1.* https://www.w3.org/TR/vc-data-model-1.1/
